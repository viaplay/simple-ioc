...
module.exports = function() {
	...
	pub.isResolvable = function( name ) {
		return isResolvables[ name ] || ( isResolvables[ name ] = isResolvable( name ) );
	};
	...
	pub.renameRegistered = function( from, to ) {
		injectableSingletonStore[ to ] = injectableSingletonStore[ from ];
		injectableTransientStore[ to ] = injectableTransientStore[ from ];
		pub.removeRegistered( from );
	};
	return pub;
};